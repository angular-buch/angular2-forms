...
var gasService_1 = require('../../../app/models/gasService');
testing_1.describe('dashboard component', function () {
    testing_1.beforeEachProviders(function () { return [dashboard_component_1.default, gasService_1.default, http_1.HTTP_PROVIDERS]; });
